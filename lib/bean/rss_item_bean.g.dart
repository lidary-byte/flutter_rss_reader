...
void _rssItemBeanSerialize(
  ...
  writer.writeString(offsets[5], object.feedName);
  writer.writeBool(offsets[6], object.fullText);
  writer.writeString(offsets[7], object.link);
  writer.writeLong(offsets[8], object.openType);
  writer.writeDateTime(offsets[9], object.pubDate);
...
RssItemBean _rssItemBeanDeserialize(
  ...
  final object = RssItemBean(
    ...
    feedId: reader.readLong(offsets[4]),
    feedName: reader.readString(offsets[5]),
    link: reader.readStringOrNull(offsets[7]),
    pubDate: reader.readDateTimeOrNull(offsets[9]),
  ...
  object.fullText = reader.readBool(offsets[6]);
  object.id = id;
  object.openType = reader.readLong(offsets[8]);
