...
extension FeedBeanByIndex on IsarCollection<FeedBean> {
  Future<FeedBean?> getByUrl(String? url) {
    return getByIndex(r'url', [url]);
  }

  FeedBean? getByUrlSync(String? url) {
  ...
  Future<List<FeedBean?>> getAllByUrl(List<String?> urlValues) {
    final values = urlValues.map((e) => [e]).toList();
    return getAllByIndex(r'url', values);
  }

  List<FeedBean?> getAllByUrlSync(List<String?> urlValues) {
    final values = urlValues.map((e) => [e]).toList();
  ...
  Future<Id> putByUrl(FeedBean object) {
    return putByIndex(r'url', object);
  }

  Id putByUrlSync(FeedBean object, {bool saveLinks = true}) {
    return putByIndexSync(r'url', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByUrl(List<FeedBean> objects) {
    return putAllByIndex(r'url', objects);
  }

  List<Id> putAllByUrlSync(List<FeedBean> objects, {bool saveLinks = true}) {
...
extension FeedBeanQueryWhere on QueryBuilder<FeedBean, FeedBean, QWhereClause> {
  ...
  QueryBuilder<FeedBean, FeedBean, QAfterWhereClause> urlIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FeedBean, FeedBean, QAfterWhereClause> urlIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FeedBean, FeedBean, QAfterWhereClause> urlEqualTo(String? url) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'url',
        value: [url],
  ...
  QueryBuilder<FeedBean, FeedBean, QAfterWhereClause> urlNotEqualTo(
      String? url) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
