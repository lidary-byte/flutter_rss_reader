...
ThemeData lightTheme(BuildContext context, ColorScheme? lightDynamic) {
  return ThemeData(
    ...
    dividerTheme: const DividerThemeData().copyWith(color: HexColor('#8D8D8D')),
    ...
    bottomAppBarTheme: const BottomAppBarTheme().copyWith(color: Colors.white),
    extensions: [
      CustomBottomNavTheme(
        ...
        activeNavigationBarColor: (cacheDynamicColor && lightDynamic != null)
            ...
            : Colors.orange,
        // 未选中
        notActiveNavigationBarColor: (cacheDynamicColor && lightDynamic != null)
    ...
    extensions: [
      CustomBottomNavTheme(
        ...
        activeNavigationBarColor: (cacheDynamicColor && darkDynamic != null)
            ...
            : Colors.orange,
        // 未选中
        notActiveNavigationBarColor: (cacheDynamicColor && darkDynamic != null)
